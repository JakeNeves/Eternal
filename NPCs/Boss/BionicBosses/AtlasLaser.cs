...
{
    public class AtlasLaser : ModNPC
    {
        ...
        {
            DisplayName.SetDefault("XR-2006 Atlas-X9 Laser");
        }
        ...
        public override void AI()
        {
            RotateNPCToTarget();
            attackTimer++;
            if (attackTimer == 50 || attackTimer == 55 || attackTimer == 60 || attackTimer == 65 || attackTimer == 150 || attackTimer == 155 || attackTimer == 160 || attackTimer == 165)
            {
