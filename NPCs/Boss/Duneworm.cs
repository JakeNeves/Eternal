...
{
    internal class DunewormHead : DunewormBoss
    {
        ...
        public override void SetDefaults()
        {
            ...
            npc.width = 110;
            npc.height = 60;
            npc.knockBackResist = 50;
            npc.value = Item.buyPrice(gold: 30);
        }

		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			//Duneworm is currently under testing right now...
			return 0f;
		}
    ...
    internal class DunewormBody : DunewormBoss
    {
    ...
    internal class DunewormTail : DunewormBoss
    {
    ...
    public abstract class DunewormBoss : Duneworm
    {
        ...
        public override void Init()
        {
            minLength = 150;
            maxLength = 275;
            tailType = NPCType<DunewormTail>();
            bodyType = NPCType<DunewormBody>();
            headType = NPCType<DunewormHead>();
            speed = 9.75f;
            turnSpeed = 0.15f;
        }
    }

    public abstract class Duneworm : ModNPC
    {
		public bool head;
		public bool tail;
