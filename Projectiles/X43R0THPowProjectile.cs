...
{
    class X43R0THPowProjectile : ModProjectile
    {

		private const string ChainTexturePath = "Eternal/Projectiles/X43R0THPowProjectileChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("The X43R0TH Pow");
		}
		...
		// Using the Example Mod Code Because I am Lazy 
