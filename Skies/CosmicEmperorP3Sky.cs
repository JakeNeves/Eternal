...
{
    public class CosmicEmperorP3Sky : CustomSky
    {
        ...
        {
            this._bgTexture = TextureManager.Load("Skies/Textures/CosmicEmperorSky/Background");
            this._planetTexture = TextureManager.Load("Skies/Textures/CosmicEmperorSky/Planet");
            this._beamTexture = TextureManager.Load("Skies/Textures/CosmicEmperorSky/Beam");
            Mod omd = Eternal.instance;
        }
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            if (maxDepth >= 3.40282347E+38f && minDepth < 3.40282347E+38f)
            {
                ...
                spriteBatch.Draw(Main.blackTileTexture, new Rectangle(0, 0, Main.screenWidth, Main.screenHeight), Color.DarkRed * 0.05f);
            ...
            {
                spriteBatch.Draw(Main.blackTileTexture, new Rectangle(0, 0, Main.screenWidth, Main.screenHeight), Color.OrangeRed * 0.05f);
            }
        }
