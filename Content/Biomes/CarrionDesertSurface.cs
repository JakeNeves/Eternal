...
{
    public class CarrionDesertSurface : ModBiome
    {
        ...
        public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.GetInstance<CarrionDesertSurfaceBackgroundStyle>();
        ...
        {
            bool b1 = ModContent.GetInstance<BiomeTileCount>().carrionDesertBlockCount >= 96;

            bool b2 = Math.Abs(player.position.ToTileCoordinates().X - Main.maxTilesX / 2) < Main.maxTilesX / 6;

	        bool b3 = player.ZoneSkyHeight || player.ZoneOverworldHeight && player.ZoneDesert;
