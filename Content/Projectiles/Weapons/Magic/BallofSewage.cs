...
{
    public class BallofSewage : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<Sludge>(), Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f, 100);
