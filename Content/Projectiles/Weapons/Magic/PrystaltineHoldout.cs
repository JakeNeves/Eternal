...
{
    public class PrystaltineHoldout : ModProjectile
    {
        ...
        private void FireBeams()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, beamVelocity, ModContent.ProjectileType<PrystaltineLaser>(), damage, knockback, Projectile.owner, b, uuid);
            }
