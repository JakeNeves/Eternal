...
{
    public class SactothsConquestProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Color dustColor = Color.Lerp(Color.Purple, Color.HotPink, Main.rand.NextFloat() * 0.3f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = Color.MediumPurple;
            Color middleMediumColor = Color.Purple;
            Color frontLightColor = Color.Magenta;
