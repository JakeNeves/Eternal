...
{
    public class SerpentKillerProjectile : ModProjectile
    {
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(entitySource, Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<SerpentKillerOrb>(), Projectile.damage, 0, Main.myPlayer, 0f, 0f);
				Projectile.Kill();
				return;
			}
			else
