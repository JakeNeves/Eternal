...
{
    public class BladeofEternalDivinityProjectile : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = Color.Purple;
            Color middleMediumColor = Color.Gray;
            Color frontLightColor = Color.White;
