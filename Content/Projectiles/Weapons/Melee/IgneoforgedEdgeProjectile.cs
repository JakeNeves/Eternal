...
{
    public class IgneoforgedEdgeProjectile : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            target.AddBuff(BuffID.OnFire3, 1 * 30 * 15, false);
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = Color.Red;
            Color middleMediumColor = Color.OrangeRed;
            Color frontLightColor = Color.Orange;
