...
{
    public class LipomaProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(12))
            {
                ...
                {
                    if (!Main.dedServ)
                        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(Main.rand.Next(-4, 4), Main.rand.Next(-4, 4)), ProjectileID.GoldenShowerFriendly, Projectile.damage, 0.0f, Main.myPlayer, 0.0f, 0.0f);
                }
            }
        }
    }
