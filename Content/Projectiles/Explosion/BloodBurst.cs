    ...
    public class BloodBurst : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int num120 = 0; num120 < 60; num120++)
            {
                ...
                int num122 = Dust.NewDust(Projectile.Center - Vector2.One * num121, num121 * 2, num121 * 2, DustID.Blood);
            ...
            for (int k = 0; k < 5; k++)
            {
                Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.Blood, Projectile.oldVelocity.X * 0.25f, Projectile.oldVelocity.Y * 0.25f);
            }
