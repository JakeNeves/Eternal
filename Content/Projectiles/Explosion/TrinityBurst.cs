...
{
    public class TrinityBurst : ModProjectile
    {
        ...
        public override void AI()
        {
            for (int k = 0; k < 5; k++)
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.GemAmethyst, Projectile.oldVelocity.X * 1f, Projectile.oldVelocity.Y * 1f);
            }
        }
