...
namespace Eternal.Content.Projectiles.Explosion
{
    public class CosmicSpirit : ModProjectile
    {
        ...
        public override void AI()
        {
            for (int k = 0; k < 5; k++)
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<Dusts.CosmicSpirit>(), Projectile.oldVelocity.X * 1f, Projectile.oldVelocity.Y * 1f);
            }
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int num120 = 0; num120 < 60; num120++)
            {
                ...
                int num122 = Dust.NewDust(Projectile.Center - Vector2.One * num121, num121 * 2, num121 * 2, ModContent.DustType<Dusts.CosmicSpirit>());
            ...
            for (int k = 0; k < 5; k++)
            {
                Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, ModContent.DustType<Dusts.CosmicSpirit>(), Projectile.oldVelocity.X * 0.25f, Projectile.oldVelocity.Y * 0.25f);
            }
