...
{
    public class ShadeBombFriendly : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (BombTimer >= 15f && !Main.dedServ)
            {
                ...
                {
                    Projectile.NewProjectile(entitySource, Projectile.Center, new Vector2(0f, 4f), ModContent.ProjectileType<ShadeBomb2Friendly>(), Projectile.damage / 2, 0);
                    Projectile.NewProjectile(entitySource, Projectile.Center, new Vector2(0f, -4f), ModContent.ProjectileType<ShadeBomb2Friendly>(), Projectile.damage / 2, 0);
                }

                if (Projectile.velocity.Y != 0)
                {
                    Projectile.NewProjectile(entitySource, Projectile.Center, new Vector2(4f, 0f), ModContent.ProjectileType<ShadeBomb2Friendly>(), Projectile.damage / 2, 0);
                    Projectile.NewProjectile(entitySource, Projectile.Center, new Vector2(-4f, 0f), ModContent.ProjectileType<ShadeBomb2Friendly>(), Projectile.damage / 2, 0);
                }
