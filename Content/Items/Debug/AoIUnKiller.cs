...
namespace Eternal.Content.Items.Debug
{
    public class AoIUnKiller : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            {
                if (DownedBossSystem.downedRiftArkofImperious)
                {
                    Item.useStyle = ItemUseStyleID.HoldUp;
                    Item.UseSound = SoundID.Item4;
                    Item.useAnimation = 15;
                    Item.useTime = 15;
                    DownedBossSystem.downedRiftArkofImperious = false;
                    Main.NewText("Effects have been undone, kill the Ark of Imperious in the Rift again to redo the effect...", 0, 215, 215);
                }
            }
            else
            {
