...
{
    public class PsycheSlime : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange([
                new FlavorTextBestiaryInfoElement("When the glow of the darkened moon, shines upon the horizon, helpless slimes become psychebound by occultic energy!")
            ]);
        }
