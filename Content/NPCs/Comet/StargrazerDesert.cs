...
{
    public class StargrazerDesert : ModNPC
    {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            if (ModContent.GetInstance<ZoneSystem>().zoneComet && player.ZoneDesert)
            {
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.ByCondition(postCosmicApparitionDrop, ModContent.ItemType<JumboStar>(), 18));
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            int gore2 = Mod.Find<ModGore>("StargrazerDesertBlades").Type;
