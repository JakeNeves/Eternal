    ...
    public class CosmicApparition : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
                ...
                new FlavorTextBestiaryInfoElement("A lost soul, seeking vengance on anything that attacks. Perhaps it's taking revenge on someone by showing them, what it's made of...")
            });
        }
        ...
        public override void AI()
        {
            ...
            if (phase == 1)
            {
                ...
                if (DifficultySystem.hellMode && !isDead)
                {
            ...
            if (isDead)
            {
                ...
                DeathTimer++;
                if (DeathTimer > 0 && DeathTimer < 100)
                {
                    NPC.life = 1;
                    NPC.dontTakeDamage = true;
