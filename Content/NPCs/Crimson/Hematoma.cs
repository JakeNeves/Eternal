    ...
    public class Hematoma : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
                ...
                new FlavorTextBestiaryInfoElement("These disgusting abominations have been floating somewhere in the Crimson")
            });
        }
        ...
        public override void OnKill()
        {
            ...
            int gore1 = Mod.Find<ModGore>("Hematoma1").Type;
            int gore2 = Mod.Find<ModGore>("Hematoma2").Type;
            int gore3 = Mod.Find<ModGore>("Hematoma3").Type;
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.ByCondition(postCosmicApparitionDrop, ModContent.ItemType<MysteryMeat>(), 4, 2, 6));
        }
    }
}
