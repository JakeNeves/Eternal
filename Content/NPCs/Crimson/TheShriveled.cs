...
namespace Eternal.Content.NPCs.Crimson
{
    public class TheShriveled : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("A posthumous monstrosity that has lurked amongst the Crimson, who knows what this thing is capable of...")
            });
        }
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.ByCondition(postCosmicApparitionDrop, ModContent.ItemType<MysteryMeat>(), 4, 4, 8));
        }
        ...
        public override void AI()
        {
            ...
            {
                for (int k = 0; k < 5; k++)
                    Dust.NewDust(NPC.position + new Vector2(0f, 8f), NPC.width / 2, 0, DustID.Blood, 1.5f, -1.5f, 0, default, Main.rand.NextFloat(0.75f, 1.25f));
            }
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            {
                for (int k = 0; k < 5; k++)
                    Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.Blood, 2.5f, -2.5f, 0, default, 1.7f);
            }
            else
            {
                Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.Blood, 0, -1f, 0, default(Color), 1f);
            }
        }
