...
namespace Eternal.Content.NPCs.Carrion
{
    public class Cadavera : ModNPC
    {
        ...
        public override void OnKill()
        {
            ...
            int gore1 = Mod.Find<ModGore>("CadaveraArm").Type;
            int gore2 = Mod.Find<ModGore>("CadaveraLeg").Type;
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
                NPC.NewNPC(entitySource, (int)NPC.position.X, (int)NPC.position.Y, ModContent.NPCType<CadaveraHead>());
        }
