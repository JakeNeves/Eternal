...
{
    public class StarbornInquisitorMagic : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
                ...
                new FlavorTextBestiaryInfoElement("Perhaps, one of the strongest entities anyone has encountered, this one can fire an unstable wisp!")
            });
        }
        ...
        public override void AI()
        {
            ...
            if (attackTimer == 200)
            {
                    ...
                    if (Main.netMode != NetmodeID.MultiplayerClient)
                        Projectile.NewProjectile(entitySource, NPC.Center.X, NPC.Center.Y, direction.X + A, direction.Y + B, ModContent.ProjectileType<UnstableStarbornInquisitorWisp>(), NPC.damage, 1, Main.myPlayer, 0, 0);
