...
{
    public class DegradedCarminiteAmalgamationTenticle : ModNPC
    {
        public override string Texture => "Eternal/Content/NPCs/Boss/CarminiteAmalgamation/CarminiteAmalgamationTenticle";
        ...
        public override void AI()
        {
            ...
            if (!NPC.AnyNPCs(ModContent.NPCType<DegradedCarminiteAmalgamation>()))
            {
                NPC.active = false;
            }
            ...
            {
                if (Main.npc[i].type == ModContent.NPCType<DegradedCarminiteAmalgamation>())
                {
                    parent = Main.npc[i];
                    break;
                }
            ...
            if (!parent.active || ModContent.NPCType<DegradedCarminiteAmalgamation>() < 0)
            {
                NPC.active = false;
                return;
            }
