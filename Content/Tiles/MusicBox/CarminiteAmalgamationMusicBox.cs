...
namespace Eternal.Content.Tiles.MusicBox
{
    public class CarminiteAmalgamationMusicBox : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<Items.Placeable.MusicBox.CarminiteAmalgamationMusicBox>();
        }
