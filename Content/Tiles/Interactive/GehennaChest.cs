...
{
    public class GehennaChest : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<Items.Placeable.Interactive.GehennaChest>(), 1);
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            else
            {
                if (isLocked)
                {
                    int key = ModContent.ItemType<GehennaKey>();
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Interactive.GehennaChest>();
                    if (Main.tile[left, top].TileFrameX / 36 == 1)
                    {
                        player.cursorItemIconID = ModContent.ItemType<GehennaKey>();
                    }
