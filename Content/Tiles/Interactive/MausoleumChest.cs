...
{
    public class MausoleumChest : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DustType = ModContent.DustType<Dusts.MausoleumTorch>();
            AdjTiles = [TileID.Containers];

            AddMapEntry(new Color(200, 200, 200), this.GetLocalization("MapEntry0"), MapChestName);
            AddMapEntry(new Color(0, 141, 63), this.GetLocalization("MapEntry1"), MapChestName);

            RegisterItemDrop(ModContent.ItemType<Items.Placeable.Interactive.MausoleumChest>(), 1);
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            else
            {
                if (isLocked)
                {
                    int key = ModContent.ItemType<MausoleumKey>();
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Interactive.MausoleumChest>();
                    if (Main.tile[left, top].TileFrameX / 36 == 1)
                    {
                        player.cursorItemIconID = ModContent.ItemType<MausoleumKey>();
                    }
