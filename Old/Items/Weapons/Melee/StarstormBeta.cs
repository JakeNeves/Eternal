...
{
    public class StarstormBeta : ModItem
    {

        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Fires swords and stars from the sky");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.useTime = 20;
            item.shoot = ModContent.ProjectileType<StarstormSword>();
            item.shootSpeed = 12f;
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int index = 0; index < numberProjectiles; ++index)
            {
                ...
                Projectile.NewProjectile(vector2_1.X, vector2_1.Y, SpeedX, SpeedY, ModContent.ProjectileType<Projectiles.Weapons.Melee.StarstormBeta>(), damage, knockBack, Main.myPlayer, 0.0f, Main.rand.Next(5));
            }
            return false;
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<SydaniteBar>(), 24);
            recipe.AddIngredient(ModContent.ItemType<ApparitionalMatter>(), 10);
            recipe.AddIngredient(ModContent.ItemType<SmiteCore>(), 6);
            recipe.AddIngredient(ModContent.ItemType<StarstormAlpha>());
