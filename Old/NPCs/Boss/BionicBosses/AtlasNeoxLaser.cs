...
{
    public class AtlasNeoxLaser : ModNPC
    {
        ...
        {
            DisplayName.SetDefault("EXR-2306 Atlas-N30X Class-X Laser");
        }
        ...
        public override void AI()
        {
            RotateNPCToTarget();
            attackTimer++;
            if (attackTimer == 50 || attackTimer == 52 || attackTimer == 56 || attackTimer == 60 || attackTimer == 150 || attackTimer == 155 || attackTimer == 160 || attackTimer == 165)
            {
                ...
                for (int i = 0; i < amountOfProjectiles; ++i)
                {
                    ...
                    if (Main.netMode != NetmodeID.MultiplayerClient)
                        Projectile.NewProjectile(npc.Center.X, npc.Center.Y, direction.X + A, direction.Y + B, ModContent.ProjectileType<Projectiles.Enemy.AtlasNeoxLaser>(), npc.damage, 1, Main.myPlayer, 0, 0);
                }
            }
            if (attackTimer == 170)
            {
